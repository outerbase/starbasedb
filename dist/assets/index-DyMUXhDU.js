...
var ft = { Stringify: 1, BeforeStream: 2, Stream: 3 },
    ...
    vt = (e) => {
        ...
        const n = [e],
            i = {}
        return (
            t.forEach((r) => r({ phase: ft.Stringify, buffer: n, context: i })),
            n[0]
        )
    },
    ie = Symbol('RENDERER'),
    ...
    yt = (e) => {
        ...
        return (n.values = t), (n.Provider = n), (n[ie] = Fe(t)), D.push(n), n
    },
    I = (e) => e.values.at(-1),
    K = {
        title: [],
...
var At = new Map([
    ...
    w = class {
        ...
        toStringToBuffer(e) {
            ...
            let { children: i } = this
            e[0] += `<${t}`
            const r = F && I(F) === 'svg' ? (s) => $t(te(s)) : (s) => te(s)
                ...
                if (((s = r(s)), s !== 'children')) {
                    if (s === 'style' && typeof a == 'object') {
                        ...
                        if (typeof a == 'number' || a.isEscaped)
                            e[0] += ` ${s}="${a}"`
                        else if (typeof a == 'boolean' && Tt.includes(s))
                            a && (e[0] += ` ${s}=""`)
                ...
                if (n instanceof Promise)
                    if (D.length === 0) e.unshift('', n)
                        ...
                        e.unshift(
                            ...
                            n.then(
                                (r) => (
                                    r instanceof w && (r.localContexts = i), r
                                )
                            )
                        )
                    }
...
var H = '_hp',
    ...
    Re = (e) => {
        ...
        if (t) {
            const [, n, i] = t
            return (ce[e] = [(Rt[n] || n).toLowerCase(), !!i])
        }
    },
    Pe = (e, t) =>
        _ &&
            ...
            if (r !== 'children' && (!n || n[r] !== s)) {
                ...
                if (a) {
                    ...
                    typeof s == 'string'
                        ? (l.cssText = s)
                        : ((l.cssText = ''),
                          s != null && Ue(s, l.setProperty.bind(l)))
                } else {
                    if (r === 'value') {
                        const f = e.nodeName
                        if (
    ...
    Ve = (e, t, n) => {
        e.c === t && ((e.c = n), e.vC.forEach((i) => Ve(i, t, n)))
    },
    Me = (e, t) => {
        var n, i
        ;(n = t[C][2]) == null ||
    ...
    Nt = (e, t) => {
        ...
        Ee(e, i, !0), Ve(e, i, t), t.replaceChildren(i)
    },
    ...
    Ce = (e, t) => {
        ...
        const [, i] = n,
            ...
            a = r[s]
        return (
            Qe(a == null ? void 0 : a[1], t) ? (r[s] = [e, t]) : (e = r[s][0]),
            e
        )
    },
    _t = (e) => {
    ...
    It = (e, t) => {
        ...
        const [, i] = n,
            ...
            s = i[C][0]++,
            a = r[s]
        return Qe(a == null ? void 0 : a[1], t) && (r[s] = [e(), t]), r[s][0]
    },
...
var nt = (e, t = {}) => {
    ...
    en = (e) => e.replace(Qt, (t, n, i, r, s) => n || i || r || s || ''),
    it = (e, t) => {
        var a, l
        const n = [],
            i = [],
...
`
console.log('Client-side code executing')
const _e = document.getElementById('ssr-root')
_e &&
    (console.log('Found SSR root, hydrating'),
    Xt(_e, A(ze, { children: A(st, {}) })))
const Ie = document.getElementById('spa-root')
Ie && nt(Ie).render(A(ze, { children: A(st, {}) }))
